...
export const ActivityMasterForm: React.FC<ActivityMasterFormProps> = ({
  ...
  const onSubmit = async (data: ActivityMasterFormValues) => {
    try {
      setLoading(true);
      if (initialData) {
        await axios.patch(`/api/${params.storeId}/activitiesMaster/${params.activityMasterId}`, data);
      } else {
        await axios.post(`/api/${params.storeId}/activitiesMaster`, data);
      }
      router.refresh();
      router.push(`/${params.storeId}/activitiesMaster`);
  ...
  const onDelete = async () => {
    try {
      setLoading(true);
      await axios.delete(`/api/${params.storeId}/activitiesMaster/${params.activityMasterId}`);
      router.refresh();
      router.push(`/${params.storeId}/activitiesMaster`);

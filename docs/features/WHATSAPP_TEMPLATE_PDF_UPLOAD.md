...
2. Pick a PDF (`≤ 5 MB`). The control validates the file type/size before upload.
...
## Notes
- Requests are rejected for non-PDF mimetypes, empty bodies, or files larger than `5 MB`.

...
- After creating the query, use get_tour_query_pdf to download a PDF of the itinerary.`,
    {
      ...
      numAdults: z.union([z.string(), z.number()]).optional().describe("Number of adults (optional)"),
      numChild5to12: z.union([z.string(), z.number()]).optional().describe("Children aged 5-12 (optional)"),
      numChild0to5: z.union([z.string(), z.number()]).optional().describe("Children aged 0-5 (optional)"),

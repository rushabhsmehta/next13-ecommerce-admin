...
const components = [
  ...
  // Attempt: represent each button as a separate 'button' component
  { type: 'BUTTON', sub_type: 'PHONE_NUMBER', index: 0, parameters: [ { type: 'payload', payload: '+919724444701' } ] },
  { type: 'BUTTON', sub_type: 'URL', index: 1, parameters: [ { type: 'payload', payload: 'https://aagamholidays.com/' } ] },
  { type: 'BUTTON', sub_type: 'FLOW', index: 2, parameters: [ { type: 'payload', payload: JSON.stringify({ flow_id: 1529773194683122, action: 'NAVIGATE', screen: 'QUESTION_ONE' }) } ] }
];

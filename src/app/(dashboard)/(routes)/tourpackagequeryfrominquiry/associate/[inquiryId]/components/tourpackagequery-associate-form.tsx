...
import { INCLUSIONS_DEFAULT, EXCLUSIONS_DEFAULT, IMPORTANT_NOTES_DEFAULT, PAYMENT_TERMS_DEFAULT, USEFUL_TIPS_DEFAULT, CANCELLATION_POLICY_DEFAULT, AIRLINE_CANCELLATION_POLICY_DEFAULT, TERMS_AND_CONDITIONS_DEFAULT, KITCHEN_GROUP_POLICY_DEFAULT, TOUR_HIGHLIGHTS_DEFAULT, DISCLAIMER_DEFAULT, DEFAULT_PRICING_SECTION } from "./defaultValues";
...
export const TourPackageQueryFromInquiryAssociateForm: React.FC<TourPackageQueryFromInquiryAssociateFormProps> = ({
    ...
    const defaultValues = initialData
        ? {
            ...
            // Populate form with inquiry data if available
            inquiryId: inquiry?.id || '',
            tourPackageTemplate: '',
            tourPackageQueryNumber: getCurrentDateTimeString(),
            tourPackageQueryName: `Query for ${inquiry?.customerName || 'Customer'}`,
    ...
    const form = useForm<TourPackageQueryFromInquiryAssociateFormValues>({
    ...
    const onSubmit = async (data: TourPackageQueryFromInquiryAssociateFormValues) => {
        try {
            setLoading(true);

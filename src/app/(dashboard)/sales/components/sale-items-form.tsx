...
type SaleItemFormValues = z.infer<typeof formSchema>;
...
export const SaleItemsForm: React.FC<SaleItemsFormProps> = ({
  initialData,
  taxSlabs,
  units,
}) => {
  ...
  const onSubmit = async (data: SaleItemFormValues) => {
    try {
      ...
      if (initialData?.id) {
        await axios.patch(`/api/sales/${initialData.id}/items`, data);
        toast.success("Sale updated with items");
      } else {
        await axios.post('/api/sales/items', {
          ...data,
          customerId: initialData.customerId,
          tourPackageQueryId: initialData.tourPackageQueryId
        });
        toast.success("Sale created with items");
      }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold">
          {initialData?.id ? "Edit Sale Items" : "Create Sale with Items"}
        </h2>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Enter general information about this sale
              </CardDescription>
            </CardHeader>
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col">
                      ...
                      <Popover>
                        ...
                        <PopoverContent className="w-auto p-0" align="start">                          <Calendar
                            mode="single"
                            selected={createDatePickerValue(field.value) || undefined}
          ...
          <Card>
            ...
            <CardFooter className="flex justify-between">
              ...
              <Button 
                ...
                className="ml-auto"
              >
                {initialData.id ? "Update Sale" : "Create Sale"}
              </Button>
            </CardFooter>
          </Card>
        </form>

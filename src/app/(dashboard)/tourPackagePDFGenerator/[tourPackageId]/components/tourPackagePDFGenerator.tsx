...
// import { renderItineraryImages } from "@/lib/itinerary-image-html"; // TEMP: itinerary images disabled
          ...
          .map((itinerary, index) => {
            ...
            return `
                    <div style="border: 1px solid ${brandColors.border}; border-radius: 10px; margin-bottom: 16px; overflow: hidden; ${avoidPageBreakStyle}">
                      ...
                      ${/* TEMP: itinerary images disabled - renderItineraryImages(itinerary.itineraryImages, itinerary.dayNumber || index + 1) */ ''}

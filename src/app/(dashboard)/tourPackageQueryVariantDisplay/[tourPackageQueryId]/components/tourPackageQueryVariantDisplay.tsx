...
// Helper function to parse policy fields from the database
...
// Helper function to parse pricing section from JSON
...
export const TourPackageQueryVariantDisplay: React.FC<TourPackageQueryVariantDisplayProps> = ({
    initialData,
    locations,
    hotels,
    associatePartners,
                ...
                <CardHeader>
                    <div>
                        ...
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <Link href={`/tourPackageQueryPDFGeneratorWithVariants/${initialData.id}?search=${selectedOption}`} className="inline-flex items-center px-3 py-2 rounded-md text-sm font-medium bg-orange-500 text-white hover:bg-orange-600">Download PDF with Variants</Link>
                        </div>

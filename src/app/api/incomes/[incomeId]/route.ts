...
export async function GET(req: Request, props: { params: Promise<{ incomeId: string }> }) {
...
export async function PATCH(req: Request, props: { params: Promise<{ incomeId: string }> }) {
  const params = await props.params;
  try {
    const { userId } = await auth();
    if (!userId) {
...
export async function DELETE(req: Request, props: { params: Promise<{ incomeId: string }> }) {
  const params = await props.params;
  try {
    const { userId } = await auth();
    if (!userId) {

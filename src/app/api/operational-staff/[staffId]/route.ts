...
export async function GET(req: Request, props: { params: Promise<{ staffId: string }> }) {
...
export async function PUT(req: Request, props: { params: Promise<{ staffId: string }> }) {
  const params = await props.params;
  try {
...
export async function PATCH(req: Request, props: { params: Promise<{ staffId: string }> }) {
  const params = await props.params;
  try {
    const { userId } = await auth();
...
export async function DELETE(req: Request, props: { params: Promise<{ staffId: string }> }) {
  const params = await props.params;
  try {
    const { userId } = await auth();

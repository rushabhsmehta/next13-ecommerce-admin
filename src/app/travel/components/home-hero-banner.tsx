...
export function HomeHeroBanner() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-orange-500 via-red-500 to-purple-700 px-4 pb-10 pt-24 sm:px-6 sm:pb-14 sm:pt-28 lg:px-8">
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mt-7 flex flex-wrap gap-3">
          <Link
            href={href("/packages")}
            className="inline-flex items-center gap-2 rounded-xl bg-white px-6 py-3 text-sm font-semibold text-orange-600 shadow-lg transition hover:bg-orange-50"
          >
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-xl border border-white/35 bg-white/10 px-6 py-3 text-sm font-semibold text-white backdrop-blur-sm transition hover:bg-white/20"
          >
